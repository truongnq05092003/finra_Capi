import { hasInjectionContext, inject, version, unref, defineComponent, ref, provide, createElementBlock, h, computed, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, getCurrentInstance, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, shallowRef, isReadonly, withCtx, isRef, isShallow, isReactive, toRaw, markRaw } from 'vue';
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-CwOoSIgU.mjs');
...
const unhead_FtoMzzldgl = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "dich-vu-slug",
    path: "/dich-vu/:slug()",
    component: () => import('./index-ZG2C2lEq.mjs').then((m) => m.default || m)
  },
  {
    name: "dich-vu-KKH",
    path: "/dich-vu/KKH",
    component: () => import('./index-DnH1N-UU.mjs').then((m) => m.default || m)
  },
  {
    name: "dich-vu-TLCK",
    path: "/dich-vu/TLCK",
    component: () => import('./index-DStsrQ_Z.mjs').then((m) => m.default || m)
  },
  {
    name: "dich-vu-TLHT",
    path: "/dich-vu/TLHT",
    component: () => import('./index-BWmJKSac.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-TnBoA31o.mjs').then((m) => m.default || m)
  },
  {
    name: "san-pham",
    path: "/san-pham",
    component: () => import('./index-x7eiJ39K.mjs').then((m) => m.default || m)
  },
  {
    name: "tuyen-dung-slug",
    path: "/tuyen-dung/:slug()",
    component: () => import('./index-DmhC5EG2.mjs').then((m) => m.default || m)
  },
  {
    name: "tuyen-dung",
    path: "/tuyen-dung",
    component: () => import('./index-DUdsGZ9_.mjs').then((m) => m.default || m)
  },
  {
    name: "ve-chung-toi",
    path: "/ve-chung-toi",
    component: () => import('./index-C305AFcl.mjs').then((m) => m.default || m)
  }
];
...
const revive_payload_server_si90HK7aN2 = /* @__PURE__ */ defineNuxtPlugin({
...
const axios_QMFgzss1s4 = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugins = [
  unhead_FtoMzzldgl,
  plugin$1,
  revive_payload_server_si90HK7aN2,
  plugin,
  components_plugin_KR1HBZs4kY,
  axios_QMFgzss1s4
];
const layouts = {
  default: () => import('./default-DUQHkEE-.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-fHtb85Mn.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-6nnEVp9k.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.12.4_@parcel+watcher@2.4.1_@types+node@22.4.0_ioredis@5.4.1_magicast@0.3.4_rollup@4.21_4efuwyz5z2jszis4lr343h3efy/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.12.4_@parcel+watcher@2.4.1_@types+node@22.4.0_ioredis@5.4.1_magicast@0.3.4_rollup@4.21_4efuwyz5z2jszis4lr343h3efy/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { On as O, _export_sfc as _, navigateTo as a, useRuntimeConfig as b, withoutTrailingSlash as c, resolveUnrefHeadInput as d, entry$1 as default, useNuxtApp as e, useRoute$1 as f, br as g, hasProtocol as h, injectHead as i, joinURL as j, nuxtLinkDefaults as n, parseQuery$1 as p, resolveRouteObject as r, useRouter as u, withTrailingSlash as w };
