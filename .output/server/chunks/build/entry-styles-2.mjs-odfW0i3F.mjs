  ...
  off(events2, handler) {
    ...
    events2.split(" ").forEach((event) => {
      if (typeof handler === "undefined") {
        ...
        self.eventsListeners[event].forEach((eventHandler2, index) => {
...
export { Autoplay as A, Navigation as N, Pagination as P, Swiper2 as S, SwiperSlide as a, a11y as b, effectCreative as c, effectCube as d, effectCards as e, effectFade as f, effectFlip as g, freeMode as h, grid as i, scrollbar as j, navigation as n, pagination as p, swiper as s, virtual as v, zoom as z };
//# sourceMappingURL=entry-styles-2.mjs-odfW0i3F.mjs.map
